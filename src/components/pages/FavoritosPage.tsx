...
export default function FavoritosPage({ showBackButton = false, onBack, hideHeader = false }: Props) {
  ...
  const removeFromFavorites = (id: string) => {
    Alert.alert('Quitar favorito', 'Â¿Quitar este producto de tus favoritos?', [
  ...
  const clearAll = () => {
    Alert.alert('Limpiar favoritos', 'Â¿Quitar todos los favoritos?', [
      { text: 'Cancelar', style: 'cancel' },
            ...
            >
              ...
              <View style={styles.cardInfo}>
                ...
                <View style={styles.cardFooter}>
                  ...
                  <Text style={styles.cardRating}>â˜… {product.rating}</Text>
                </View>
              </View>
