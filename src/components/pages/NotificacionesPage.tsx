...
const initialNotifications: Notification[] = [
  {
    id: 1,
    title: 'Oferta Especial de CafÃ©',
    description: 'Tu cafÃ© favorito EtiopÃ­a disponible con 20% descuento. Â¡Solo por hoy!',
    time: '1h',
    icon: 'ðŸŽ‰',
    read: false,
    type: 'promo',
  ...
  },
  {
    ...
    description: 'Tu pedido #576404 fue entregado exitosamente. Â¡Gracias por tu compra!',
    time: '1d',
    icon: 'âœ…',
    read: true,
    type: 'order',
  ...
  {
    id: 4,
    title: 'CafÃ© Brasil Especial',
    description: 'Nuevo cafÃ© Brasil Limited Edition ya disponible en nuestra tienda.',
    time: '2d',
    icon: 'âœ¨',
    read: true,
    type: 'new',
  },
  {
    ...
    description: 'Has acumulado 150 puntos. CanjÃ©alos por tu prÃ³xima compra.',
    time: '3d',
    icon: 'â­',
    read: true,
    type: 'loyalty',
  ...
  {
    id: 6,
    title: 'Tu pedido estÃ¡ en camino',
    description: 'Tu pedido #741235 estÃ¡ siendo preparado y pronto estarÃ¡ en camino.',
    time: '4d',
    icon: 'ðŸ“¦',
    read: true,
    type: 'order',
